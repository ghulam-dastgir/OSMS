        ...
        <div class="row">
            <div class="col-md-2">
                <nav class="nav flex-column bg-light shadow-lg py-2">
                    ...
                    <li class="nav-item"><a href="requists.php" class="nav-link active"><i
            ...
            <div class="col-md-10">
                <div class="card shadow-lg  mr-4 mt-5">
                    ...
                    <div class="table-responsive mt-4 p-3">
                        ...
                        $limit = 5;
                        $offset = ($page - 1) * $limit;
                        $sql = "SELECT * FROM requist ORDER BY r_id DESC LIMIT $offset, $limit";
                        ...
                        <table class="table table-striped table-sm table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><?php echo $row['r_id']; ?></td>
                                    <td><?php echo substr($row['r_name'],0,6) . '..'; ?></td>
                                    <td><?php echo $row['r_email']; ?></td>
                                    <td><?php echo $row['r_address1']; ?></td>
                                    <td><?php echo $row['r_city']; ?></td>
                                    <td><?php echo substr($row['r_info'],0,9) . '..'; ?></td>
                                    <td><?php echo $row['r_date']; ?></td>
                                    <td><a href="view-requist.php?id=<?php echo $row['r_id']; ?>" class="btn btn-sm text-primary">View</a></td>
                                </tr>
                        ...
                        <nav>
                            <?php
                            $pag_sql = "SELECT r_id FROM requist";
                            ...
                            <ul class="pagination justify-content-center">
                                <?php if($page > 1) { ?>
                                <li class="page-item"><a href="requists.php?page=<?php echo ($page - 1); ?>" class="page-link">Prev</a></li>
                                ...
                                ?>
                                <li class="page-item <?php echo $active; ?>"><a href="requists.php?page=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
                                <?php  } 
                                if($total_page > $page) {
                                ?>
                                <li class="page-item"><a href="requists.php?page=<?php echo ($page + 1); ?>" class="page-link">Next</a></li>
                                <?php } ?>
                            </ul>
                        </nav>
                    </div>
