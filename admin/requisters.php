...
<nav class="nav flex-column bg-light shadow-lg py-2">
    ...
    <li class="nav-item"><a href="requisters.php" class="nav-link active"><i
...
<div class="card shadow-lg mt-5">
    ...
    <div class="table-responsive mt-4 p-3">
        ...
        $limit = 5;
        $offset = ($page - 1) * $limit;
        $sql = "SELECT * FROM requisters ORDER BY requister_id DESC LIMIT $offset, $limit";
        ...
        <table class="table table-striped table-sm table-bordered text-center">
            ...
            <tbody>
                ...
                <tr>
                    <td class="font-weight-bold"><?php echo $row['requister_id']; ?></td>
                    <td><?php echo $row['requister_name']; ?></td>
                    <td><?php echo $row['requister_email']; ?></td>
                    <td><a href="delete-requister.php?id=<?php echo $row['requister_id']; ?>" class="btn btn-sm text-danger">Delte</a>
                    </td>
                </tr>
        ...
        <nav>
            <?php
            $pag_sql = "SELECT requister_id FROM requisters";
            ...
            <ul class="pagination justify-content-center">
                <?php if($page > 1) { ?>
                <li class="page-item"><a href="requisters.php?page=<?php echo ($page - 1); ?>" class="page-link">Prev</a></li>
                ...
                ?>
                <li class="page-item <?php echo $active; ?>"><a href="requisters.php?page=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
                <?php  } 
                if($total_page > $page) {
                ?>
                <li class="page-item"><a href="requisters.php?page=<?php echo ($page + 1); ?>" class="page-link">Next</a></li>
                <?php } ?>
            </ul>
        </nav>
    </div>
