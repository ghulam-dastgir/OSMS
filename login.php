...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul id="menu" class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="login.php" class="nav-link up-case">Login</a></li>
    ...
    <div id="login">
        <div class="text-center services-content text-white"><h2 class="font-weight-bold d-inline">Login</h2>
    ...
    <div class="container mt-5" id="user-login">
        <div class="row">
            <div class="col-md-8 offset-2">
                <h3 class="text-center mb-4 login-heading">Requister <span class="text-primary"> login </span></h3>
                <div class="shadow-lg p-4">
                <?php
                include("includes/config.php");
                include("includes/functions.php");
                if(isset($_POST['login'])) {
                if(trim($_POST['Remail']) == "" || trim($_POST['Rpassword']) == "") {
                    $error_msg = "<p class='text-danger'>All fields requisred.</p>";
                } else{
                    $reqEmail = htmlentities(mysqli_real_escape_string($conn,$_POST['Remail']));
                    $reqPass = htmlentities(mysqli_real_escape_string($conn,sha1($_POST['Rpassword'])));
                    requister_log($conn,$reqEmail,$reqPass);
                }
            }
                ...
                ?>
                 ...
                 if(isset( $_SESSION['login_error'])) { echo  $_SESSION['login_error'];  session_unset(); }
                  ?>
