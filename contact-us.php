...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul id="menu" class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="contact-us.php" class="nav-link up-case">Contact Us</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <div id="contact">
        <div class="text-center services-content text-white"><h2 class="font-weight-bold d-inline">Contact Us</h2>
        <p class="up-case mt-4">we are our 20 years of experience</p>
        </div>
    </div>
    ...
    <div id="callRequist" class="bg-white">
        <div class="container p-3 my-5 text-center text-white">
            <h2 class="text-dark">Send Us a <span class="text-primary">Message</span></h2>
